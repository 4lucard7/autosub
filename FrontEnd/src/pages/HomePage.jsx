          ...
          {loggedIn ? (
            <>
              ...
              <div className="relative group">
                ...
                {/* Dropdown Menu */}
                <div className="absolute right-0 top-10 w-48 bg-white border border-gray-100 rounded-xl shadow-lg py-1 hidden group-hover:block z-50">
                  <div className="px-4 py-2.5 border-b border-gray-50 mb-1">
                    <p className="text-[11px] font-medium text-gray-400 mb-0.5">Signed in as</p>
                    <p className="text-[13px] font-semibold text-gray-800 truncate">{email}</p>
                  </div>
                  <Link to="/settings" className="flex items-center gap-2 px-4 py-2 text-[13px] text-gray-600 hover:bg-gray-50 transition-colors">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-4 py-2 text-[13px] text-red-500 hover:bg-red-50 transition-colors text-left"
                  >
